...
namespace AdminUtilsClient
{
    class Dictionary
    {
        ...
        public static List<string> pedsF = new List<string>
        {
        ...
        public static List<string> pedsM = new List<string>
            {
        ...
        public static List<string> pedsT = new List<string> 
        {
        ...
        public static List<string> pedsTest = new List<string> 
        {
                "CS_abe",
        ...
        public static Dictionary<string, Vector3> places = new Dictionary<string, Vector3>
        {
            //Mid-Eastern Locations
            {"Emerald Ranch Fence", new Vector3(1417.818F,268.0298F,89.61942F)},
            {"UFO Cult House",new Vector3(1469.529F,803.9516F,100.2565F)},
            {"Rhodes",new Vector3(1232.205F,-1251.088F,73.67763F)},
            {"Rhodes Sheriff Station",new Vector3(1359.575F,-1301.451F,77.76775F)},
            {"Braithwaite Manor",new Vector3(1010.883F,-1741.42F,46.57271F)},
            {"Caliga Hall",new Vector3(1748.701F,-1373.015F,44.07471F)},
            //Saint Denis Locations
            {"Saint Denis Entrance",new Vector3(2209.557F,-1346.319F,45.27962F)},
            {"Saint Denis Police Dept. HQ",new Vector3(2519.439F,-1309.522F,48.98456F)},
            {"Cornwall Freight",new Vector3(2327.491F,-1502.421F,46.15683F)},
            {"Saint Denis Paperboy",new Vector3(2683.755F,-1401.467F,46.36121F)},
            {"Saint Denis Post Office",new Vector3(2747.493F,-1403.775F,46.19331F)},
            {"Schiffer Brewery",new Vector3(2626.123F,-1219.239F,53.24075F)},
            {"Holdern Barber",new Vector3(2663.265F,-1182.402F,53.18868F)},
            {"Theatre Raleur",new Vector3(2531.462F,-1271.88F,49.19459F)},
            {"Park Gazebo (Dominos)",new Vector3(2520.084F,-1250.082F,50.04138F)},
            {"Milliners (Clothes)",new Vector3(2552.014F,-1176.577F,53.31112F)},
            {"Dr. Joseph R Barnes MD (Doctor)",new Vector3(2725.046F,-1240.167F,49.9267F)},
            {"Kuo Chao and Co (Guns)",new Vector3(2724.051F,-1283.323F,49.40885F)},
            {"Horner & Co General Store",new Vector3(2819.6F,-1311.311F,46.73164F)},
            {"Saint Denis Trapper",new Vector3(2831.333F,-1227.615F,47.64871F)},
            {"Saint Denis Fence",new Vector3(2849.29F,-1203.049F,47.69022F)},
            {"Doyle Tavern",new Vector3(2792.439F,-1176.049F,47.94577F)},
            {"Marcel Beliveau (Photography)",new Vector3(2734.564F,-1111.322F,48.8867F)},
            {"Fontana Theatre",new Vector3(2683.063F,-1365.809F,47.4687F)},
            {"Sisika Penitentiary",new Vector3(3348.683F,-638.0975F,44.96677F)},
            //North East Locations
            {"Van Horn",new Vector3(2983.451F,430.152F,51.17512F)},
            {"Van Horn Lighthouse",new Vector3(3034.831F,434.7511F,63.76253F)},
            {"Better than my dog Crashed Boat",new Vector3(3587.617F,1412.362F,41.64929F)},
            {"Annesburg",new Vector3(2904.366F,1248.808F,44.87448F)},
            {"Annesburg Mines",new Vector3(2811.514F,1350.152F,71.40891F)},
            {"Willard Rest (and Waterfalls)",new Vector3(2962.592F,2206.051F,165.286F)},
            {"Doverhill (Tesla Coil)",new Vector3(2528.707F,2289.215F,176.5532F)},
            {"Ambarino Sign",new Vector3(1977.036F,1782.974F,191.9578F)},
            {"Veteran Homestead",new Vector3(1695.536F,1517.756F,146.7541F)},
            //Northern Locations
            {"Grizzlies Train Station (Bridge/Large Waterfall)",new Vector3(571.4683F,1709.609F,187.5573F)},
            {"Barrow Lagoon",new Vector3(-1022.5F,1682.607F,242.1601F)},
            {"Mount Hagen",new Vector3(-1504.352F,1246.987F,313.6848F)},
            {"Frozen Couple",new Vector3(-1596.308F,1838.178F,299.4427F)},
            {"Grizzlies Camp (Tutorial Area)",new Vector3(-1343.558F,2425.952F,307.4015F)},
            //North West Locations  
            {"Monto Rest (Building Camp)",new Vector3(-1389.252F,-235.0196F,98.85808F)},
            {"Fort Wallace",new Vector3(361.913F,1461.297F,179.1987F)},
            {"Valentine Sheriff Station",new Vector3(-278.2138F,807.0493F,119.38F)},
            {"Strawberry",new Vector3(-1731.426F,-412.8995F,154.8678F)},
            {"Strawberry Sheriff Station",new Vector3(-1809.933F,-349.4936F,164.6563F)},
            //South West Locations
            {"Tanner Reach",new Vector3(-2370.176F,-1595.122F,154.0966F)},
            {"Swadlass Point",new Vector3(-2573.16F,-1371.534F,149.7127F)},
            {"Upper Montana River",new Vector3(-2003.783F,-1058.096F,77.02795F)},
            {"Manzanita Post",new Vector3(-1962.67F,-1614.491F,116.0338F)},
            {"Native Attack Site",new Vector3(-2037.57F,-1917.054F,110.0583F)},
            {"Macfarlane Ranch",new Vector3(-2333.056F,-2350.935F,63.20446F)},
            {"Roots Chapel",new Vector3(-3322.755F,-2833.409F,-6.234455F)},
            {"Armadillo",new Vector3(-3665.947F,-2612.442F,-14.08434F)},
            {"Benedict Point",new Vector3(-5245.899F,-3470.671F,-22.09243F)},
            {"Tumbleweed",new Vector3(-5517.375F,-2936.821F,-2.219434F)},
            {"Rathskeller Fork",new Vector3(-5165.079F,-2143.5F,11.77453F)},
            {"Ridgewood Farm",new Vector3(-4823.544F,-2711.381F,-13.74694F)},
            {"Mercer Station",new Vector3(-4352.891F,-3052.94F,-11.10614F)},
            {"Fort Mercer",new Vector3(-4217.854F,-3514.639F,36.98927F)},
            {"Gaptooth Breach",new Vector3(-6000.769F,-3319.31F,-21.72198F)},
        };
    }
}